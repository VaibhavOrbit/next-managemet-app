        ...
        <div className="w-full md:w-1/3 flex flex-col gap-4">
          <div className="bg-white rounded-md p-4 ">
            ...
            <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
               ...
               <Link className="p-3 rounded-md bg-red-100" href="/">Teacher&apos;s Classes</Link>
               <Link className="p-3 rounded-md bg-yellow-100" href="/">Teacher&apos;s Classes</Link>
                <Link className="p-3 rounded-md bg-green-100" href="/">Teacher&apos;s Classes</Link>
            </div>
            </div>
            <PerfomanceChart/>
