 ...
 const Navbar = () => {
  return (  
    <div className="flex items-center justify-between p-4">
        {/* seacrhbar */}
        <div className="hidden md:flex gap-3 ring-[1.5px] ring-gray-300 p-2 items-center text-sm rounded-full">
     ...
     <div className="flex items-center gap-6 justify-end w-full ">
            ...
            <div className="flex flex-col">
               <span className="text-xs leading-3 font-medium">Joe Goldberg</span>
